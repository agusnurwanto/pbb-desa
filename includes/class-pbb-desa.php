...
class Pbb_Desa {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Pbb_Desa_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'PBB_DESA_VERSION' ) ) {
			$this->version = PBB_DESA_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'pbb-desa';
	 ...
	 *
	 * - Pbb_Desa_Loader. Orchestrates the hooks of the plugin.
	 * - Pbb_Desa_i18n. Defines internationalization functionality.
	 * - Pbb_Desa_Admin. Defines all hooks for the admin area.
	 * - Pbb_Desa_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pbb-desa-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-pbb-desa-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-pbb-desa-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-pbb-desa-public.php';
	 ...
	 *
	 * Uses the Pbb_Desa_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_public_hooks() {
		...
		add_shortcode('manajemen_pbb_pengawas', array($plugin_public, 'manajemen_pbb_pengawas'));
	 ...
	 *
	 * @since     1.0.0
	 * @return    Pbb_Desa_Loader    Orchestrates the hooks of the plugin.
	 */
